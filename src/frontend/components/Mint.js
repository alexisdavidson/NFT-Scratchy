...
const Mint = ({ account, nft, web3Handler, balance }) => {
    ...
    return (
        <Row className="m-0 p-0 mint">
            ...
            {submenu == 1 ? (
                <MintCard account={account} web3Handler={web3Handler} nft={nft} balance={balance}
                    cardClass="scratchyCardGenesis" mintActivated={true}
                ...
                <>
                    ...
                    {
                        {
                            '1': <MintCard account={account} web3Handler={web3Handler} 
                            ...
                            '2': <MintCard account={account} web3Handler={web3Handler} 
