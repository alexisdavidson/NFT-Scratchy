        ...
        <Row className="m-0 p-0 mint">
            ...
            {submenu == 1 ? (
                ...
                <>
                    ...
                    {
                        {
                            '1': <MintCard cardClass="scratchyCard1" mintActivated={false} nextPage={nextPage} subpage={subpage}
                            ...
                            '2': <MintCard cardClass="scratchyCard2" mintActivated={false} nextPage={nextPage} subpage={subpage}
                            ...
                            '3': <MintCard cardClass="scratchyCardEmpty" cardText="?" mintActivated={false} nextPage={nextPage} subpage={subpage}
                            ...
                            '4': <MintCard cardClass="scratchyCardEmpty" cardText="?" mintActivated={false} nextPage={nextPage} subpage={subpage}
